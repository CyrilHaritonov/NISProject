...
* На сервере создается новое поле в базе данных для пользователя с его данными
...
* Подается запрос на приложение/сайте
* На сервере ищется поле в базе данных данного пользователя  и проверяется корректность пароля
